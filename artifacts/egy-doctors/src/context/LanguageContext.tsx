...
const translations = {
  en: {
    ...
    register: {
      ...
      otpTitle: "Verify Your WhatsApp Number",
      otpSent: "WhatsApp OTP sent",
      otpDesc: (phone: string) => `We sent a 6-digit verification code to ${phone} via WhatsApp. Enter it below to finish creating your account.`,
      otpLabel: "Verification Code",
      otpPlaceholder: "Enter the code (use 1234 for development)",
      otpVerify: "Verify & Create Account",
      otpInvalid: "Invalid verification code. Please try again.",
      otpResend: "Resend Code",
      otpResent: "A new WhatsApp OTP has been sent",
      fullName: "Full Name",
      email: "Email Address",
      phone: "Phone Number",
      password: "Password",
  ...
  ar: {
    ...
    register: {
      ...
      otpTitle: "تأكيد رقم واتساب الخاص بك",
      otpSent: "تم إرسال رمز التحقق عبر واتساب",
      otpDesc: (phone: string) => `أرسلنا رمز تحقق مكوّن من أرقام إلى ${phone} عبر واتساب. أدخله بالأسفل لإتمام إنشاء حسابك.`,
      otpLabel: "رمز التحقق",
      otpPlaceholder: "أدخل الرمز (استخدم 1234 للتطوير)",
      otpVerify: "تحقق وأنشئ الحساب",
      otpInvalid: "رمز التحقق غير صحيح. يرجى المحاولة مرة أخرى.",
      otpResend: "إعادة إرسال الرمز",
      otpResent: "تم إرسال رمز تحقق جديد عبر واتساب",
      fullName: "الاسم الكامل",
